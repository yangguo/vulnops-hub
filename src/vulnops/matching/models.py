...
class Exposure(Base):
    ...
    match_class: Mapped[str] = mapped_column(
        String(32), nullable=False
    )  # confirmed|deterministic|corroborated|candidate|not_affected|superseded
...
class MatchEvidence(Base):
    ...
    __table_args__ = (Index("ix_match_evidence_exposure", "exposure_id"),)
