...
| Replay | Partial | Source snapshot, SBOM, DefectDojo, and Wazuh idempotency tests; *2026-09-12: real DefectDojo API replay of 24 findings drained to queue depth 0 without creating snapshots or pending evidence events* | Add cold cursor recovery and external projection deduplication evidence |
